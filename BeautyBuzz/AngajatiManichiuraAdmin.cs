...
{
    public partial class AngajatiManichiuraAdmin : UserControl
    {
        private SqlConnection connection;
        private SqlDataAdapter dataAdapter;
        private DataTable dataTable;

        public AngajatiManichiuraAdmin()
        {
            InitializeComponent();
        ...
        private void InitializeDataGridView()
        {
            ...
            string query = "SELECT Id, Nume_Salon, Nume_Angajat, Prenume_Angajat, Nr_Telefon, Oras FROM ANGAJATIManichiura";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                try
                {
                    ...
                    SqlCommand updateCmd = new SqlCommand("UPDATE ANGAJATIManichiura SET nume_salon = @nume_salon, nume_angajat = @nume_angajat, prenume_angajat = @prenume_angajat, nr_telefon = @nr_telefon, oras = @oras WHERE id = @id", connection);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                try
                {
                    ...
                    SqlCommand command = new SqlCommand("DELETE FROM ANGAJATIManichiura WHERE Id = @Id", connection);
        ...
        private void AngajatiManichiuraAdmin_Load(object sender, EventArgs e)
        {
            InitializeDataGridView();
        }
    }
